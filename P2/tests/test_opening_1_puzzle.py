...
from p2_1331_01_junoy_capote import Solution3, Solution2


class Solution1(StudentHeuristic):  # PiecesCounter
    ...
    def evaluation_function(self, state: TwoPlayerGameState) -> float:
        player_pieces = 0
        opponent_pieces = 0
        current_player = state.next_player.label

        # Determinar el otro jugador
        if current_player == state.game.player1.label:
            other_player = state.game.player2.label
        else:
            other_player = state.game.player1.label
...
def heuristic_1(state: TwoPlayerGameState) -> float:
    h = Solution3()
    return Solution3.evaluation_function(h, state)
...
print("1- E6  -- your score for this movement:", heuristic_1(game_state_e6),
...
print("4- F7  -- your score for this movement:", heuristic_1(game_state_f7),
